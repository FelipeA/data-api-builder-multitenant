...
public class GraphQLRequestHandlerMiddleware
{
    private readonly RequestDelegate _next;
    private readonly RuntimeConfigProvider _runtimeConfigProvider;
    private readonly MultiTenantTokenService _tokenService;

    public GraphQLRequestHandlerMiddleware(RequestDelegate next, RuntimeConfigProvider runtimeConfigProvider, MultiTenantTokenService tokenService)
    {
        _next = next;
